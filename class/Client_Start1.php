...
<script src="resource/js/Map.js" type="text/javascript"></script>
<script src="resource/js/Ship.js" type="text/javascript"></script> 
<script src="resource/js/Ajax.js" type="text/javascript"></script> 
<script src="resource/js/BoundingBoxHitTest.js" type="text/javascript"></script> 
<script>
  var stage;
  var direction = "up";
    var tmpship;
